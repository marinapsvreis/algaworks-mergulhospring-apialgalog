...
import com.algaworks.algalog.api.input.OcorrenciaInput;
...
public class OcorrenciaControler {
	...
	public OcorrenciaDTO registrar(@PathVariable Integer entregaId, @Valid @RequestBody OcorrenciaInput ocorrenciaInput) {
	...
	@GetMapping
	public List<OcorrenciaDTO> lista(@PathVariable Integer entregaId){
